...
public class RunModelMS {
	...
	{		                                   		
        ...
        time = line.split(":")[3].trim().split(",")[0].split("\"")[1];
        LOG.info("time is "+time);
        v1 = line.split(":")[4].trim().split(",")[0].split("\"")[1];
        LOG.info("v1 is "+v1);
        v2 = line.split(":")[5].trim().split(",")[0].split("\"")[1];
        v3 = line.split(":")[6].trim().split(",")[0].split("\"")[1];
        v4 = line.split(":")[7].trim().split(",")[0].split("\"")[1];
        v5 = line.split(":")[8].trim().split(",")[0].split("\"")[1];
        v6 = line.split(":")[9].trim().split(",")[0].split("\"")[1];
        v7 = line.split(":")[10].trim().split(",")[0].split("\"")[1];
        v8 = line.split(":")[11].trim().split(",")[0].split("\"")[1];
        v9 = line.split(":")[12].trim().split(",")[0].split("\"")[1];
        v10 = line.split(":")[13].trim().split(",")[0].split("\"")[1];
        v11 = line.split(":")[14].trim().split(",")[0].split("\"")[1];
        v12 = line.split(":")[15].trim().split(",")[0].split("\"")[1];
        v13 = line.split(":")[16].trim().split(",")[0].split("\"")[1];
        v14 = line.split(":")[17].trim().split(",")[0].split("\"")[1];
        v15 = line.split(":")[18].trim().split(",")[0].split("\"")[1];
        v16 = line.split(":")[19].trim().split(",")[0].split("\"")[1];
        v17 = line.split(":")[20].trim().split(",")[0].split("\"")[1];
        v18 = line.split(":")[21].trim().split(",")[0].split("\"")[1];
        v19 = line.split(":")[22].trim().split(",")[0].split("\"")[1];
        v20 = line.split(":")[23].trim().split(",")[0].split("\"")[1];
        v21 = line.split(":")[24].trim().split(",")[0].split("\"")[1];
        v22 = line.split(":")[25].trim().split(",")[0].split("\"")[1];
        v23 = line.split(":")[26].trim().split(",")[0].split("\"")[1];
        v24 = line.split(":")[27].trim().split(",")[0].split("\"")[1];
        v25 = line.split(":")[28].trim().split(",")[0].split("\"")[1];
        v26 = line.split(":")[29].trim().split(",")[0].split("\"")[1];
        v27 = line.split(":")[30].trim().split(",")[0].split("\"")[1];
        v28 = line.split(":")[31].trim().split(",")[0].split("\"")[1];
        amount = line.split(":")[32].trim().split(",")[0].split("\"")[1];
